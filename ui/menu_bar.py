...
class MenuBar(QMenuBar):
    ...
    def __init__(self, parent):
        ...
        self.file_new = QAction(QIcon("icons/menu_bar/file-plus-corner.svg"),self.tr("&New Project"), parent)
        ...
        self.file_open = QAction(QIcon("icons/menu_bar/folder-open.svg"), self.tr("&Open Project"), parent)
        ...
        self.file_save = QAction(QIcon("icons/menu_bar/save.svg"), self.tr("&Save Project"), parent)
        ...
        self.file_save_as = QAction(QIcon("icons/menu_bar/save-all.svg"), self.tr("Save Project As..."), self)
        self.file_save_as.setShortcut("Ctrl+Shift+S")
        file_menu.addAction(self.file_save_as)
        
        file_menu.addSeparator()
        
        self.import_file = QAction(QIcon("icons/menu_bar/file-down.svg"), self.tr("&Import Data"), parent)
        ...
        self.import_sheets = QAction(QIcon("icons/menu_bar/google-sheets-logo-icon.svg"), self.tr("&Import from Google Sheets"), parent)
        self.import_sheets.setToolTip(self.tr("Import data from Google Sheet"))
        file_menu.addAction(self.import_sheets)

        self.import_database = QAction(QIcon("icons/menu_bar/database.svg"), self.tr("Import from &Database"), parent)
        ...
        self.export_code = QAction(QIcon("icons/menu_bar/python-5.svg"), self.tr("&Export to Python (.py) file"), parent)
        ...
        exit_action = QAction(QIcon("icons/menu_bar/log-out.svg"), self.tr("E&xit"), parent)
        ...
        self.undo_action = QAction(QIcon("icons/menu_bar/undo-2.svg"), self.tr("&Undo"), parent)
        self.undo_action.setShortcut("Ctrl+Z")
        self.undo_action.setToolTip(self.tr("Undo the last action"))
        edit_menu.addAction(self.undo_action)
        
        self.redo_action = QAction(QIcon("icons/menu_bar/redo-2.svg"), self.tr("&Redo"), parent)
        self.redo_action.setShortcut("Ctrl+Y")
        self.redo_action.setToolTip(self.tr("Redo the previous action"))
        edit_menu.addAction(self.redo_action)

        edit_menu.addSeparator()
        self.settings_action = QAction(QIcon("icons/menu_bar/settings.svg"), self.tr("&Settings"), parent)
        ...
        self.zoom_in_action = QAction(QIcon("icons/menu_bar/zoom-in.svg"), self.tr("Zoom &In"), parent)
        self.zoom_in_action.setShortcut("Ctrl++")
        self.zoom_in_action.setToolTip(self.tr("Zoom into the plot"))
        view_menu.addAction(self.zoom_in_action)
        
        self.zoom_out_action = QAction(QIcon("icons/menu_bar/zoom-out.svg"), self.tr("Zoom &Out"), parent)
        ...
        self.export_data_action = QAction(QIcon("icons/menu_bar/file-up.svg"), self.tr("&Export Data"), parent)
        ...
        self.about_action = QAction(QIcon("icons/menu_bar/info.svg"), self.tr("&About"), parent)
