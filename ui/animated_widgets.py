from PyQt6.QtWidgets import QPushButton, QGroupBox, QLineEdit, QComboBox, QSpinBox, QDoubleSpinBox, QCheckBox, QRadioButton, QLabel, QStyle, QApplication, QTabWidget, QMenu, QGraphicsDropShadowEffect, QListWidget
