from PyQt6.QtWidgets import QPushButton, QGroupBox, QLineEdit, QComboBox, QSpinBox, QDoubleSpinBox, QCheckBox, QRadioButton, QLabel, QStyle, QApplication, QTabWidget, QMenu, QGraphicsDropShadowEffect, QListWidget, QSlider, QDialog
from PyQt6.QtCore import QPropertyAnimation, QEasingCurve, pyqtProperty, Qt, pyqtSignal, QSize
