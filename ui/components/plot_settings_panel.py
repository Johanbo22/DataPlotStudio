from PyQt6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QLabel, QScrollArea, QFontComboBox, QToolBox, QFrame, QLayout
...
class PlotSettingsPanel(QWidget):
    ...
    def _create_basic_tab(self):
        ...
        # Assuming signal connection handled by controller/view logic, but button needs exposing
        self.refresh_subsets_btn = refresh_subsets_btn 
        # Note: logic for 'refresh_subset_list' is in PlotTab logic class.
        # We expose the button, and PlotTab connects to it via the bridge.
    ...
    def _create_legend_tab(self):
        ...
        self.grid_which_type_combo.setToolTip(
            "major = Primary gridlines\nminor = Secondary gridlines\nboth = All gridlines")
    ...
    def _create_annotations_tab(self):
        ...
        self.textbox_position_combo.addItems(
            ['upper left', 'upper center', 'upper right', 'center left', 'center', 'center right', 'lower left',
